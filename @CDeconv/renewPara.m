function [outDeconv,outGradList] = renewPara(obj,inDistriList,inGradList,state)
...
outGradList(1,3).x1 = 0;%outDeconv.kernel_x1 - inDistriList(1,3).x1;
outGradList(1,3).x2 = 0;%outDeconv.kernel_x2 - inDistriList(1,3).x2;